...
public class ARVOREFINAL {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (Op == 2) // Inserir Elemento na Árvore
            {
                boolean Status;                // Variável para receber o status de inserção do Elemento na Árvore

                String x;                      // Valor a ser inserido

                System.out.print("\n\nDigite um Nome: ");
                x = S.nextLine();

                Status = MinhaÁrvore.Inserir1(x);
            ...
            if (Op == 9) // Pesquisar um Elemento na Árvore
            {
                int Altura;
            ...
            if (Op == 3) // Listar os Elementos da Árvore - "EM ORDEM"
            {
                if (MinhaÁrvore.Raiz == null) {
                    ...
                    MinhaÁrvore.ListarEMORDEM(MinhaÁrvore.Raiz, MinhaÁrvore.Raiz);
                }
                S.nextLine();
            }
